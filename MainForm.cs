...
namespace MetaDataStringEditor {
    public partial class MainForm : Form {
        ...
        private Редактирование editForm = new Редактирование();

        // 菜单栏
        private void LoadToolStripMenuItem_Click(object sender, EventArgs e) {
            if (status == FormStatus.Loading || status == FormStatus.Saving) {
                Logger.E("Выполняется фоновая операция");
                return;
            }
        ...
        private void SearchToNext() {
            ...
            Logger.I("Поиск ничего не нашел");
        }
